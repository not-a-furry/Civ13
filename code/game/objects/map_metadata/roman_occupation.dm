/obj/map_metadata/roman_occupation
	...
	roundend_condition_sides = list(
		...
		list(GREEK) = /area/caribbean/british,
		)
	age = "313 B.C."
	ordinal_age = 1
	faction_distribution_coeffs = list(ROMAN = 0.35, GREEK = 0.65)
...
/obj/map_metadata/roman_occupation/job_enabled_specialcheck(var/datum/job/J)
	..()
	if (J.is_occupation && J.title != "DONT USE" && istype(J, /datum/job/roman) || istype(J, /datum/job/greek))
		. = TRUE
